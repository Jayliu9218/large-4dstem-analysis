...
def _render_report(summary: dict[str, Any], phase_labels: np.ndarray, *, base_dir: Path) -> str:
    ...
    lines.extend([
        "> **Caution:** The diffraction-class labels are generated by unsupervised "
        "clustering of radial fingerprints. They should **not** be interpreted as "
        "confirmed crystallographic phases without Stage-2 validation (py4DSTEM / "
        "pyxem Bragg indexing or template matching).",
        "",
        "## Data",
        "",
...
def _html_qc_banner(qc: dict[str, Any]) -> list[str]:
    ...
    lines.extend([
        ...
        "<strong>⚠ Caution:</strong> The diffraction-class labels are generated by unsupervised "
        "clustering of radial fingerprints. They should <strong>not</strong> be interpreted as "
        "confirmed crystallographic phases without Stage-2 validation (py4DSTEM / pyxem "
        "Bragg indexing or template matching).",
        "</blockquote>",
    ])
    return lines
